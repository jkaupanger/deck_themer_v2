...
hdp_test_results = hdp_param_checker(min_df_0=5, min_df_f=6, k0_0=2, k0_f=10, k0_s=7, alpha_0=-1, alpha_f=1, eta_0=-1,
                                     eta_f=1, gamma_0=-1, gamma_f=1, corpus=corpus, word_list=decklists, to_excel=True,
                                     fname='..\\tests\TestResults\obfuscated_tdm_param_checking_results.xlsx')
